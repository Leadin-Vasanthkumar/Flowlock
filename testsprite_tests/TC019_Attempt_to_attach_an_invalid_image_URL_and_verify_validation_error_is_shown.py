...
async def run_test():
    ...
    try:
        ...
        # -> Type the test credentials into the email and password fields and click Sign In.
        ...
        # -> Fill Email and Password fields with test credentials and click Sign In to log in (attempt login).
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=/html/body/div/div/main/div/form/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('example@gmail.com')
        ...
        await expect(frame.locator('text=Invalid image URL or format').first).to_be_visible(timeout=3000)
